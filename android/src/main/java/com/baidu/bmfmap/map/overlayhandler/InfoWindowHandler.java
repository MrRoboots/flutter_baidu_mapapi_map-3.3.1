...
import com.baidu.bmfmap.MapViewFactory;
...
public class InfoWindowHandler extends OverlayHandler {
    ...
    private AbstractMap.SimpleEntry<String, InfoWindow> mapToInfoWindowEntry(Map<String, Object> infoWindowMap) {
        ...
        String title = new TypeConverter<String>().getValue(infoWindowMap, "title");
        if (null == title) {
            if (Env.DEBUG) {
        ...
        //添加操作自定义InfoWindow
        View view = LayoutInflater.from(MapViewFactory.context).inflate(R.layout.layout_passenger_maker, null);
        TextView makerNumTv = view.findViewById(R.id.makerPhoneTV);
        makerNumTv.setText(title);
        ...
        InfoWindow infoWindow = new InfoWindow(bitmap, latLng, yOffSet.intValue(), new InfoWindow.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick() {
                ...
                mMapController.getMethodChannel().invokeMethod(InfoWindowProtocol.sMapDidClickedInfoWindowMethod, infoWindowMap);
            }
        });
